...
const renderer = new THREE.WebGLRenderer({
    antialias: true,
    canvas : document.querySelector('.mooncanvas')
});
...
let topTexture = loader.load('top.jpg');
let bottomTexture = loader.load('bottom.jpg');
let rightTexture = loader.load('left.jpg');
let leftTexture = loader.load('right.jpg');
